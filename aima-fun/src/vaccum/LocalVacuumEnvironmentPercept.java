...
public class LocalVacuumEnvironmentPercept extends DynamicPercept {
	 ...
	 */
	public LocalVacuumEnvironmentPercept(Integer agentLocation,
	 ...
	 *         or B.
	 */
	public Integer getAgentLocation() {
		return (Integer) getAttribute(ATTRIBUTE_AGENT_LOCATION);
	}
	
	public boolean isAgentAtRightBoundary() {
		return (getAgentLocation() == VacuumEnvironment.RIGHT_BOUND);
	}
	
	public boolean isAgentAtLeftBoundary() {
		return (getAgentLocation() == VacuumEnvironment.LEFT_BOUND);
	}
